...
public class PointCPTest3
{
  ...
  public static void main(String[] args)
  {
    ...
    System.out.println("This is design 2 which store Cartesian coordinates only");
    ...
    System.out.println("\nYou entered:\n" + point);
    System.out.println("\nAfter asking to store as Cartesian:\n" + "Cartesian result is (" +point +")");
    System.out.println("\nAfter asking to store as Polar:\n" + "Stored as Polar [" + point.convertStorageToPolar()+"]");
  ...
  private static PointCP3 getInput() throws IOException
  {
    ...
    boolean isOK = true;  // Flag set if input correct
